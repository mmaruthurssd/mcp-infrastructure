...
describe('ConflictDetectionSystem', () => {
    describe('detectConflicts()', () => {
        ...
        it('should detect file-level conflicts', () => {
            ...
            const fileConflict = result.conflicts.find((c) => c.type === ConflictType.FILE_LEVEL);
        ...
        it('should detect dependency conflicts', () => {
            ...
            const depConflict = result.conflicts.find((c) => c.type === ConflictType.DEPENDENCY);
...
//# sourceMappingURL=conflict-detection-system.test.js.map