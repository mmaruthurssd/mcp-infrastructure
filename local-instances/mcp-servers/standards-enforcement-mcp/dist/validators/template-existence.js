 ...
 */
export async function validateTemplateExists(context) {
    const issues = [];
    ...
    const newTemplatePath = path.join(workspacePath, 'templates-and-patterns', 'mcp-server-templates', `${mcpName}-template`);
    const oldTemplatePath = path.join(workspacePath, 'templates', 'drop-in-templates', `${mcpName}-template`);
 ...
 */
async function validateTemplateMetadata(templatePath, mcpName) {
    const issues = [];
    // Check for README.md
 ...
 */
async function validateReadmeContent(readmePath, mcpName) {
    const issues = [];
    try {
 ...
 * Validate template.json content
 */
async function validateTemplateJson(templateJsonPath, mcpName) {
    const issues = [];
    try {
 ...
 * Validate template structure
 */
async function validateTemplateStructure(templatePath, _mcpName) {
    const issues = [];
 ...
 */
async function validateTemplateInstallable(templatePath, _mcpName) {
    const issues = [];
...
//# sourceMappingURL=template-existence.js.map