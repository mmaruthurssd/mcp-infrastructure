 ...
 */
export function testPattern(pattern: CredentialPattern, text: string): boolean {
 ...
 */
export function getHighConfidencePatterns(minConfidence: number = 0.9): CredentialPattern[] {
 ...
 */
export function getPatternsBySeverity(severity: CredentialPattern['severity']): CredentialPattern[] {
 ...
 */
export function getCriticalPatterns(): CredentialPattern[] {
