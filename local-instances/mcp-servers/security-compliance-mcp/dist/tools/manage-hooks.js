 ...
 */
import { installPreCommitHook, uninstallPreCommitHook, checkHookStatus, } from '../hooks/hook-manager.js';
import { auditHookInstalled, auditHookUninstalled, generateCorrelationId, } from '../audit/audit-helper.js';
/**
 * Manage git hooks
 */
export async function manageHooks(args) {
 ...
 */
export function formatHookManagementResult(result) {
    const lines = [];
