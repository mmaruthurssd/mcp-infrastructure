...
import { auditCredentialScan, auditCredentialViolation, generateCorrelationId, } from '../audit/audit-helper.js';
/**
 * Scan for credentials based on mode
 */
export async function scanForCredentials(args) {
    ...
    for (const violation of allViolations) {
        await auditCredentialViolation(violation.file, violation.pattern, violation.severity, correlationId);
    }
    return {
 ...
 */
export function formatScanResults(result) {
    const lines = [];
    // Header
...
//# sourceMappingURL=scan-for-credentials.js.map