  ...
  try {
    ...
    switch (name) {
      case 'analyze_code_quality': {
        const result = await analyzeCodeQuality(args as any);
        return {
      ...
      case 'detect_complexity': {
        const result = await detectComplexity(args as any);
        return {
          content: [{ type: 'text', text: JSON.stringify(result, null, 2) }],
        };
      }
      ...
      case 'find_code_smells': {
        const result = await findCodeSmells(args as any);
        return {
          content: [{ type: 'text', text: JSON.stringify(result, null, 2) }],
        };
      }
      ...
      case 'track_technical_debt': {
        const result = await trackTechnicalDebt(args as any);
        return {
          content: [{ type: 'text', text: JSON.stringify(result, null, 2) }],
        };
      }
      ...
      case 'generate_review_report': {
        const result = await generateReviewReport(args as any);
        return {
          content: [{ type: 'text', text: JSON.stringify(result, null, 2) }],
        };
      }
