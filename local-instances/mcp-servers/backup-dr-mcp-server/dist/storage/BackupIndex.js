    ...
    async queryBackups(params) {
        ...
        if (params?.filter) {
            ...
            if (sources && sources.length > 0) {
                results = results.filter(b => sources.some(source => b.sources.includes(source)));
            }
            if (label) {
...
//# sourceMappingURL=BackupIndex.js.map