...
# Version: 1.0.0
#
# Automatically configures Claude Code to use the communications MCP server
#
# Usage:
...
# Create the new server configuration (no env vars by default)
...
print_info "After restarting, the server will be ready to use!"
print_info "Communication methods available:"
echo "  • Google Chat Webhook (no setup needed)"
echo "  • SMTP Email (requires credentials - see SETUP.md)"
echo "  • Gmail/Chat API (requires OAuth - see SETUP.md)"
echo ""

print_info "Test with:"
echo "  'Send \"Hello\" to Google Chat webhook [URL]'"
echo ""
