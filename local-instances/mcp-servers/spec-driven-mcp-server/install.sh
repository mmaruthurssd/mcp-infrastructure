...
###############################################################################
# Spec-Driven MCP Server - Automated Installation Script
# Version: 1.0.0
#
# This script automates the installation of the spec-driven MCP server template
...
TEMPLATE_NAME="spec-driven-mcp-server-template"
INSTANCE_NAME="spec-driven-mcp-server"
...
TEMPLATES_DIR="$WORKSPACE_ROOT/Templates-for-tools-frameworks-mcp-servers/mcp-server-templates/templates"
...
if [ "$SKIP_MCP_CONFIG" = false ]; then
    ...
    if [ -f "$INSTANCE_DIR/configure-mcp.sh" ]; then
        ...
        print_info "You can manually add this to your Claude Code config:"
        echo ""
        echo "{"
        echo "  \"mcpServers\": {"
...
echo "   Ask Claude: 'Do you have access to the sdd_guide tool?'"
echo ""
echo "3. Start using Spec-Driven Development:"
echo "   'I want to build a new feature using spec-driven development'"
echo ""
echo "4. Read documentation:"
echo "   $INSTANCE_DIR/README.md"
echo ""
