 ...
 */
export async function validateUnitTestParams(params) {
    // Validate sourceFile
 ...
 */
export async function validateIntegrationTestParams(params) {
 ...
 */
export async function validateCoverageParams(params) {
 ...
 */
export async function validateScenariosParams(params) {
    // Validate sourceFile
    const pathValidation = await validateFilePath(params.sourceFile);
    if (!pathValidation.valid) {
        return pathValidation;
