 ...
 */
export async function formatCode(code, parser = 'typescript') {
    try {
 ...
 */
export async function isValidCode(code, parser = 'typescript') {
    try {
 ...
 */
export function addFileHeader(sourceFile, framework) {
