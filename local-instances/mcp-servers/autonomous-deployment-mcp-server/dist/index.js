...
async function main() {
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        try {
            switch (name) {
                case "detect_issue":
                    return await detectIssue(args);
                case "suggest_approaches":
                    return await suggestApproaches(args);
                case "resolve_autonomously":
                    return await resolveAutonomously(args);
                ...
                case "manage_patterns":
                    return await managePatterns(args);
                case "get_pattern_performance":
                    return await getPatternPerformance(args);
                case "adjust_thresholds":
                    return await adjustThresholds(args);
                case "export_learning_data":
                    return await exportLearningData(args);
                default:
