 ...
 */
function containsBlockedPattern(errorMessage, blockPatterns) {
 ...
 */
async function checkDailyLimit(maxPerDay) {
    try {
 ...
 */
export async function resolveAutonomously(args) {
    try {
        ...
        for (const pattern of patterns) {
            try {
                ...
                if (match) {
                    ...
                    // Select approach
                    if (approachId) {
                        selectedApproach = pattern.suggestedApproaches.find((a) => a.id === approachId) || null;
                        if (!selectedApproach) {
                        ...
                        selectedApproach = pattern.suggestedApproaches.reduce((highest, current) => current.confidence > highest.confidence ? current : highest);
                    }
                    break;
                }
            }
...
//# sourceMappingURL=resolve-autonomously.js.map