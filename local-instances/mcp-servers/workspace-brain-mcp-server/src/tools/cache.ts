...
// Get cache file path
function getCacheFilePath(brainPath: string, key: string, category?: string): string {
 ...
 */
export async function cacheSet(args: any, brainPath: string) {
  try {
 ...
 */
export async function cacheGet(args: any, brainPath: string) {
  try {
 ...
 */
export async function cacheInvalidate(args: any, brainPath: string) {
  try {
