...
export interface GoalEvaluation {
  ...
  tier: {
    ...
    confidence: string;
    reasoning: string;
    alternativeTiers?: Array<{tier: string; reasoning: string}>;
  };
}
...
export class TierSuggester {
  ...
  static suggest(
  ...
  ): { tier: string; confidence: string; reasoning: string; alternativeTiers?: Array<{tier: string; reasoning: string}> } {
    ...
    const alternativeTiers: Array<{tier: string; reasoning: string}> = [];
