  ...
  try {
    ...
    switch (name) {
      case "deploy_application": {
        const params = args as unknown as DeployApplicationParams;
      ...
      case "rollback_deployment": {
        const params = args as unknown as RollbackDeploymentParams;
      ...
      case "coordinate_release": {
        const params = args as unknown as CoordinateReleaseParams;
      ...
      case "generate_release_notes": {
        const params = args as unknown as GenerateReleaseNotesParams;
      ...
      case "monitor_deployment_health": {
        const params = args as unknown as MonitorDeploymentHealthParams;
