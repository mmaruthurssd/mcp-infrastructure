...
export async function deployToEnvironment(args) {
    const { environment, version, buildCommand = 'npm run build', runTests = true, rollbackOnFailure = true } = args;
    ...
    try {
        ...
        try {
            ...
            if (stderr)
                console.error(`[deploy] Build warnings: ${stderr}`);
        }
        catch (buildError) {
...
//# sourceMappingURL=deploy_to_environment.js.map