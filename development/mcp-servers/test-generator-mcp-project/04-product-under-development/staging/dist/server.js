        ...
        tools: [
            {
                ...
                description: 'Generate unit tests for TypeScript/JavaScript functions and classes. Analyzes source code via AST parsing and generates comprehensive test suites.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        sourceFile: {
                        ...
                        targetFile: {
                            type: 'string',
                            description: 'Optional output path for test file (default: sourceFile.test.ts in same directory)',
                        },
                        framework: {
                            type: 'string',
                        ...
                        coverage: {
                            ...
                            description: 'Test coverage level - basic (happy path), comprehensive (happy + error), edge-cases (all scenarios)',
                        },
                        functions: {
                            type: 'array',
                            items: { type: 'string' },
                            description: 'Optional: specific function names to test (default: all exported functions)',
                        },
                    },
                    required: ['sourceFile'],
                },
            },
            {
                ...
                description: 'Generate integration tests for APIs and modules. Supports REST API testing with supertest and module integration testing.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        targetModule: {
                        ...
                        framework: {
                            ...
                            enum: ['jest', 'supertest'],
                            default: 'jest',
                            description: 'Testing framework (supertest includes Jest + supertest for API testing)',
                        },
                        scenarios: {
                            type: 'array',
                            items: {
            ...
            },
            {
                ...
                description: 'Analyze test coverage gaps in a project. Parses coverage reports and identifies untested code with priority recommendations.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        projectPath: {
                        ...
                        coverageFile: {
                            type: 'string',
                            description: 'Optional path to coverage JSON file (default: auto-detect from coverage/, .nyc_output/)',
                        },
                        threshold: {
                            type: 'number',
                            default: 80,
            ...
            },
            {
                ...
                description: 'Suggest test scenarios for a source file using pattern analysis. Identifies edge cases, error conditions, and happy paths.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        sourceFile: {
                        ...
                        context: {
                            type: 'string',
                            description: "Optional context about how the code is used (e.g., 'authentication module', 'payment processing')",
                        },
                        scenarioTypes: {
                            type: 'array',
                            items: {
    ...
    try {
        ...
        switch (name) {
            case 'generate_unit_tests': {
                const result = await generateUnitTests(args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'generate_integration_tests': {
                const result = await generateIntegrationTests(args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'analyze_coverage_gaps': {
                const result = await analyzeCoverageGaps(args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'suggest_test_scenarios': {
                const result = await suggestTestScenarios(args);
                return {
                    content: [
                        {
                            type: 'text',
