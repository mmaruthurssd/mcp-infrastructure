import type { AnalyzeCoverageGapsParams, AnalyzeCoverageGapsResult } from '../types/index.js';
...
} from '../generators/coverage-analyzer.js';

/**
 * MCP Tool: analyze_coverage_gaps
 * Analyze test coverage gaps and identify files needing tests
 */
export async function analyzeCoverageGaps(params: AnalyzeCoverageGapsParams): Promise<AnalyzeCoverageGapsResult> {
  try {
    // Validate parameters
    ...
    const meetsThreshold =
      overallCoverage.statements >= threshold &&
