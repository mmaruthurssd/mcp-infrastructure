...
export class TaskValidation {
     ...
     */
    static shouldRunTestCheck(options) {
        const lowerDesc = options.taskDescription.toLowerCase();
     ...
     * Run build check
     */
    static async runBuildCheck(projectPath) {
        try {
     ...
     * Run test check
     */
    static async runTestCheck(projectPath) {
        try {
     ...
     */
    static async runSecurityCheck(projectPath) {
