      ...
      try {
        ...
        switch (name) {
          case 'create_workflow':
            result = CreateWorkflowTool.execute(args as any);
            break;

          case 'complete_task':
            result = await CompleteTaskTool.execute(args as any);
            break;

          case 'get_workflow_status':
            const statusResult = GetWorkflowStatusTool.execute(args as any);
            result = {
              ...statusResult,
          ...
          case 'archive_workflow':
            result = await ArchiveWorkflowTool.execute(args as any);
            break;
