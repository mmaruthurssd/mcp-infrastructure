...
export class ReviewWorkflow {
     ...
     */
    applyReviewDecision(issue, decision) {
     ...
     */
    generateReviewReport(candidates) {
     ...
     */
    autoApproveIfEligible(issue, config) {
        ...
        const eligible = candidate.qualityScore >= 80 &&
...
//# sourceMappingURL=review-workflow.js.map