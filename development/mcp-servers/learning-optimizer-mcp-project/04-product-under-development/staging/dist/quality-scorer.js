...
export class QualityScorer {
     ...
     */
    calculateQualityScore(issue, config) {
        let score = 0;
     ...
     */
    calculatePromotionConfidence(issue) {
        let confidence = 0;
     ...
     */
    meetsQualityStandards(issue, config) {
        const standards = config.qualityStandards || {};
        const reasons = [];
     ...
     */
    analyzePromotionCandidate(issue, config) {
        ...
        const recommendApprove = qualityScore >= 60 &&
            confidence >= 50 &&
            qualityCheck.meets &&
            warnings.length < 3;
        return {
