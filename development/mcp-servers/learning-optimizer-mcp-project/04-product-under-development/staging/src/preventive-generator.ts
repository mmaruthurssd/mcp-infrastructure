...
export class PreventiveCheckGenerator {
   ...
   */
  private generateCheckTitle(issue: TrackedIssue): string {
   ...
   */
  private generateCheckScript(issue: TrackedIssue): string {
   ...
   */
  async addPreventiveChecks(
    knowledgeBaseFile: string,
    promotedIssues: TrackedIssue[]
  ): Promise<void> {
