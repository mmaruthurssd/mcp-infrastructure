...
export class ConfigManager {
   ...
   */
  async load(): Promise<SecurityConfig> {
    try {
   ...
   */
  async update(updates: Partial<SecurityConfig>): Promise<SecurityConfig> {
    this.config = {
      ...this.config,
      ...updates,
    };
   ...
   */
  async reset(): Promise<SecurityConfig> {
    this.config = { ...DEFAULT_CONFIG };
    await this.save();
    return this.config;
  }
   ...
   */
  async addCredentialPattern(pattern: string): Promise<void> {
   ...
   */
  async addPHIPattern(pattern: string): Promise<void> {
   ...
   */
  async excludeDirectory(dir: string): Promise<void> {
   ...
   */
  async import(json: string): Promise<SecurityConfig> {
    try {
