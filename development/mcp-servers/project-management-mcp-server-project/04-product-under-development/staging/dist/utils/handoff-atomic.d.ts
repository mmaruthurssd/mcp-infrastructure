 ...
 * Created: 2025-10-27
 */
import { Handoff } from '../types/handoff.js';
import { RollbackManager } from './handoff-error-handler.js';
 ...
 */
export declare function executeAtomicHandoff<TResult>(projectPath: string, handoff: Handoff, operationFn: (transaction: AtomicTransaction) => Promise<TResult>): Promise<{
    success: boolean;
    result?: TResult;
    error?: Error;
    transactionId: string;
 ...
 */
export declare function executeAtomicBatch(projectPath: string, handoffs: Handoff[], operationsFn: (transaction: AtomicTransaction, handoff: Handoff) => Promise<void>): Promise<{
    success: boolean;
    successCount: number;
 ...
 */
export declare function withAtomicGuarantee<T>(projectPath: string, handoff: Handoff, operation: (tx: AtomicTransaction) => Promise<T>): Promise<T>;
//# sourceMappingURL=handoff-atomic.d.ts.map