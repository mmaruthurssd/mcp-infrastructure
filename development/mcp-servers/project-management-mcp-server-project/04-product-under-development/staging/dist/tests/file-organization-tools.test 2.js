...
import { validateNaming, generatePath, createFileWithMetadata, validateProjectStructure, NAMING_CONVENTIONS, YAML_TEMPLATES, } from '../tools/file-organization-tools';
// ============================================================================
// TEST UTILITIES
// ============================================================================
/**
 ...
 */
function createBasicStructure(projectPath) {
...
describe('File Organization Tools - Path Generation', () => {
    ...
    test('should generate component path', () => {
        ...
        expect(result.folderPath).toBe(path.join(testProject, '02-goals-and-roadmap', 'components', 'data-model-architecture'));
        expect(result.filePath).toBe(path.join(testProject, '02-goals-and-roadmap', 'components', 'data-model-architecture', 'COMPONENT-OVERVIEW.md'));
    });
    test('should generate sub-area path', () => {
        ...
        expect(result.folderPath).toBe(path.join(testProject, '02-goals-and-roadmap', 'components', 'data-model-architecture', 'hierarchical-data-structures'));
    ...
    test('should generate task workflow path', () => {
        ...
        expect(result.folderPath).toBe(path.join(testProject, 'temp', 'workflows', 'implement-feature-x'));
...
describe('File Organization Tools - Structure Validation', () => {
    ...
    test('should validate complete project structure', () => {
        ...
        fs.writeFileSync(path.join(testProject, '01-planning', 'PROJECT-OVERVIEW.md'), '# Project Overview', 'utf-8');
        const result = validateProjectStructure({
            projectPath: testProject,
            checkLevel: 'strict',
            autoFix: false,
...
describe('File Organization Tools - Integration & Performance', () => {
    ...
    test('should validate large project structure under 2 seconds', () => {
        ...
        for (let i = 0; i < 10; i++) {
            const compDir = path.join(testProject, '02-goals-and-roadmap', 'components', `component-${i}`);
    ...
    test('should handle concurrent operations', async () => {
        const operations = [];
        for (let i = 0; i < 50; i++) {
            operations.push(createFileWithMetadata({
...
`);
//# sourceMappingURL=file-organization-tools.test%202.js.map