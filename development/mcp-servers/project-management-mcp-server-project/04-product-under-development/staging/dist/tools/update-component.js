 ...
 */
import { updateComponent, getComponent, logComponentChange, } from '../lib/component-manager.js';
...
export class UpdateComponentTool {
    ...
    static execute(params) {
        try {
            ...
            // Update component
            const updatedComponent = updateComponent(params.projectPath, params.name, params.updates);
            ...
            if (updatedComponent.stage === 'FINALIZED') {
                propagateComponentChange(params.projectPath, updatedComponent.name, 'updated', currentComponent.stage, updatedComponent.stage);
            }
            return {
                success: true,
