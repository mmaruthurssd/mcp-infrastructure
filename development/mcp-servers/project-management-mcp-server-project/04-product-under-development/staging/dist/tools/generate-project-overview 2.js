...
import { calculateConfidence } from '../utils/information-extraction';
// ============================================================================
// TOOL IMPLEMENTATION
// ============================================================================
/**
 ...
 */
export async function generateProjectOverview(input) {
    const warnings = [];
    try {
        // Load conversation state
        const { readFile: readFilePromise } = await import('fs/promises');
        const conversationPath = join(input.projectPath, '.mcp-conversations', `${input.conversationId}.json`);
        ...
        // Get extracted data
        let extracted = conversationState.extracted;
        ...
        const projectOverview = convertToProjectOverview(templateData);
        return {
            success: true,
...
// ============================================================================
function prepareTemplateData(extracted, projectPath) {
    const projectName = extracted.projectName ||
...
// ENTITY CONVERSION
// ============================================================================
function convertToProjectOverview(templateData) {
    return {
        ...
        vision: {
            ...
            risks: templateData.vision.risks.map((r) => ({
        ...
        components: templateData.components.map((c) => c.name),
        createdAt: templateData.versionInfo.createdAt,
 ...
 */
export async function approveProjectOverview(input) {
    try {
        switch (input.action) {
            case 'approve':
...
//# sourceMappingURL=generate-project-overview%202.js.map