...
export declare function suggestNextSteps(params: z.infer<typeof SuggestNextStepsSchema>): Promise<{
    ...
    projectPhase: "completion" | "execution" | "planning" | "monitoring";
    overallProgress: number;
...
export declare function advanceWorkflowPhase(params: z.infer<typeof AdvanceWorkflowPhaseSchema>): Promise<{
    ...
    success: boolean;
    previousPhase: "completion" | "execution" | "planning" | "monitoring";
    newPhase: "completion" | "execution" | "planning" | "monitoring";
...
export {};
//# sourceMappingURL=conversation-flow-tools%202.d.ts.map