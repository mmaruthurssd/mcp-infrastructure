...
export class SplitComponentTool {
    ...
    static execute(params) {
        try {
            ...
            let archivedOriginal = undefined;
            ...
            // Propagate changes
            propagateComponentChange(params.projectPath, params.componentName, 'split', originalStage, params.keepOriginal ? originalStage : 'ARCHIVED');
            return {
                success: true,
