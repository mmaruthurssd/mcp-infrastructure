...
export class GenerateProjectConstitutionTool {
    static execute(input) {
        ...
        const sections = ConstitutionGenerator.generate(state.extractedInfo, state.projectType, mode);
        ...
        // Render constitution
        const templatePath = path.join(path.dirname(new URL(import.meta.url).pathname), '../templates/project-setup/CONSTITUTION.md');
    ...
    static formatOutput(projectName, sections, mode, filePath) {
...
//# sourceMappingURL=generate-project-constitution%202.js.map