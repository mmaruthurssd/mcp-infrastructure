...
export class ConfirmMigrationTool {
    static execute(input) {
        ...
        for (const suggestion of input.suggestions) {
            ...
            const destination = suggestion.action === 'custom' && suggestion.customDestination
    ...
    // Helper Methods
    // ==========================================================================
    static createBackup(projectPath) {
        try {
    ...
    static copyDirectory(src, dest, exclude = []) {
        try {
    ...
    static handleConflicts(projectPath, resolutions) {
    ...
    static saveMigrationReport(projectPath, data) {
        try {
...
//# sourceMappingURL=confirm-migration%202.js.map