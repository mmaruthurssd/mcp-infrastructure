...
import { Rule, RuleContext } from '../core/rule-engine.js';
 ...
 */
export const PROJECT_PLANNING_RULES: Rule[] = [
  // ============================================================
 ...
 */
export function loadProjectPlanningRules(): Rule[] {
