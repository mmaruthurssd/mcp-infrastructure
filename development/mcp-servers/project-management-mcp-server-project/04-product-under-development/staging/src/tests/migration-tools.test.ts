...
import {
  analyzeProjectForMigration,
  suggestGoalClustering,
  migrateToHierarchical,
  validateMigration,
  rollbackMigration,
} from '../tools/migration-tools';
 ...
 */
async function createMockV080Project(): Promise<void> {
...
`;
  ...
  await writeFile(
    join(TEST_PROJECT_PATH, 'brainstorming', 'future-goals', 'SELECTED-GOALS.md'),
