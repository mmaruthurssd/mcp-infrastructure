...
export async function generateQuickStartGuide(params: z.infer<typeof GenerateQuickStartGuideSchema>) {
...
export async function generateUserGuide(params: z.infer<typeof GenerateUserGuideSchema>) {
  const startTime = Date.now();
...
export async function generateAPIReference(params: z.infer<typeof GenerateAPIReferenceSchema>) {
  const startTime = Date.now();
...
export async function generateMigrationGuide(params: z.infer<typeof GenerateMigrationGuideSchema>) {
  const startTime = Date.now();
...
export async function exportProjectSummary(params: z.infer<typeof ExportProjectSummarySchema>) {
  const startTime = Date.now();

  try {
    const { projectPath, format, audience, includeDiagrams, outputPath } =
      ExportProjectSummarySchema.parse(params);
...
function generateQuickStartContent(includeExamples: boolean): string {
  const lines: string[] = [];
...
async function generateUserGuideContent(projectPath: string, sections: string[]): Promise<string> {
  const lines: string[] = [];
...
function getUserGuideSectionContent(section: string): string {
...
// ============================================================================
// CONTENT GENERATORS - API REFERENCE
// ============================================================================
...
async function discoverMCPTools(projectPath: string): Promise<MCPTool[]> {
...
function generateMarkdownAPIReference(tools: MCPTool[], includeExamples: boolean): string {
  const lines: string[] = [];
...
function generateHTMLAPIReference(tools: MCPTool[], includeExamples: boolean): string {
  return `<!DOCTYPE html>
<html>
<head>
...
function generateMigrationContent(fromVersion: string, toVersion: string): string {
  const lines: string[] = [];
...
// ============================================================================
// CONTENT GENERATORS - PROJECT SUMMARY
// ============================================================================
...
function generateMarkdownSummary(summary: ProjectSummary): string {
  const lines: string[] = [];
...
function generateHTMLSummary(summary: ProjectSummary): string {
  return `<!DOCTYPE html>
<html>
<head>
