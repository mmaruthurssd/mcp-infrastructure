...
import type { Component, ProjectOverview, MajorGoal } from '../types/hierarchical-entities.js';
...
export async function getComponentHealth(args: {
  ...
  try {
    ...
    const goals: Array<{ id: string; name: string; progress: any }> = [];
...
export const createComponentTool = {
  ...
  description:
    'Create a new component with proper folder structure and metadata file',
