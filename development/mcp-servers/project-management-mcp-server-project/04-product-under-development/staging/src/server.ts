      ...
      try {
        ...
        switch (name) {
          ...
          case 'start_project_setup':
            result = StartProjectSetupTool.execute(args as any);
            break;

          case 'continue_project_setup':
            result = ContinueProjectSetupTool.execute(args as any);
            break;

          case 'extract_project_goals':
            result = ExtractProjectGoalsTool.execute(args as any);
            break;

          case 'generate_project_constitution':
            result = GenerateProjectConstitutionTool.execute(args as any);
            break;

          case 'generate_initial_roadmap':
            result = GenerateInitialRoadmapTool.execute(args as any);
            break;

          case 'identify_resources_and_assets':
            result = IdentifyResourcesAndAssetsTool.execute(args as any);
            break;

          case 'identify_stakeholders':
            result = IdentifyStakeholdersTool.execute(args as any);
            break;

          case 'finalize_project_setup':
            result = FinalizeProjectSetupTool.execute(args as any);
            break;

          // Phase 7: Migration Tools
          case 'migrate_existing_project':
            result = MigrateExistingProjectTool.execute(args as any);
            break;

          case 'confirm_migration':
            result = ConfirmMigrationTool.execute(args as any);
            break;

          // Phase 1-2: Goal Evaluation & Creation Tools
          case 'evaluate_goal':
            const evaluationResult = await EvaluateGoalTool.execute(args as any);
            result = {
              ...evaluationResult,
          ...
          case 'create_potential_goal':
            const createResult = CreatePotentialGoalTool.execute(args as any);
            result = {
              ...createResult,
          ...
          case 'promote_to_selected':
            const promoteResult = PromoteToSelectedTool.execute(args as any);
            result = {
              ...promoteResult,
          ...
          case 'extract_ideas':
            const extractResult = ExtractIdeasTool.execute(args as any);
            result = {
              ...extractResult,
          ...
          case 'view_goals_dashboard':
            const dashboardResult = ViewGoalsDashboardTool.execute(args as any);
            result = {
              ...dashboardResult,
          ...
          case 'reorder_selected_goals':
            const reorderResult = ReorderSelectedGoalsTool.execute(args as any);
            result = {
              ...reorderResult,
          ...
          case 'update_goal_progress':
            const progressResult = UpdateGoalProgressTool.execute(args as any);
            result = {
              ...progressResult,
          ...
          case 'archive_goal':
            const archiveResult = ArchiveGoalTool.execute(args as any);
            result = {
              ...archiveResult,
          ...
          case 'check_review_needed':
            const reviewCheckResult = CheckReviewNeededTool.execute(args as any);
            result = {
              ...reviewCheckResult,
          ...
          case 'generate_review_report':
            const reportResult = GenerateReviewReportTool.execute(args as any);
            result = {
              ...reportResult,
          ...
          case 'generate_goals_diagram':
            const diagramResult = GenerateGoalsDiagramTool.execute(args as any);
            result = {
              ...diagramResult,
          ...
          case 'validate_project':
            const validateResult = ValidateProjectTool.execute(args as any);
            result = {
              ...validateResult,
          ...
          case 'initialize_project_orchestration':
            const initOrchResult = InitializeProjectOrchestrationTool.execute(args as any);
            result = {
              ...initOrchResult,
          ...
          case 'get_next_steps':
            const nextStepsResult = GetNextStepsTool.execute(args as any);
            result = {
              ...nextStepsResult,
          ...
          case 'advance_workflow_phase':
            const advanceResult = AdvanceWorkflowPhaseTool.execute(args as any);
            result = {
              ...advanceResult,
          ...
          case 'get_project_status':
            const statusResult = GetProjectStatusTool.execute(args as any);
            result = {
              ...statusResult,
          ...
          case 'validate_project_readiness':
            const readinessResult = ValidateProjectReadinessTool.execute(args as any);
            result = {
              ...readinessResult,
          ...
          case 'generate_completion_checklist':
            const checklistResult = GenerateCompletionChecklistTool.execute(args as any);
            result = {
              ...checklistResult,
          ...
          case 'wrap_up_project':
            const wrapUpResult = WrapUpProjectTool.execute(args as any);
            result = {
              ...wrapUpResult,
          ...
          case 'prepare_spec_handoff':
            const specHandoffResult = PrepareSpecHandoffTool.execute(args as any);
            result = {
              ...specHandoffResult,
          ...
          case 'prepare_task_executor_handoff':
            const taskHandoffResult = await PrepareTaskExecutorHandoffTool.execute(args as any);
            result = {
              ...taskHandoffResult,
          ...
          case 'create_component':
            result = CreateComponentTool.execute(args as any);
            break;

          case 'update_component':
            result = UpdateComponentTool.execute(args as any);
            break;

          case 'move_component':
            result = MoveComponentTool.execute(args as any);
            break;

          case 'split_component':
            result = SplitComponentTool.execute(args as any);
            break;

          case 'merge_components':
            result = MergeComponentsTool.execute(args as any);
            break;

          case 'component_to_goal':
            result = ComponentToGoalTool.execute(args as any);
            break;
