export class RollbackValidator {
    async validateRollbackTarget(targetDeployment, currentDeployment, force) {
        const checks = [];
    ...
    async checkSchemaCompatibility(targetDeployment, currentDeployment) {
    ...
    async checkConfigCompatibility(targetDeployment, currentDeployment) {
    ...
    async checkServiceDependencies(targetDeployment) {
    ...
    async validateSafetyChecks(checks, force) {
        const blockers = [];
