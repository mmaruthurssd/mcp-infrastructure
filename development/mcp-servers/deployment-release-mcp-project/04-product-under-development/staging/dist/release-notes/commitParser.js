 ...
 */
function manualParse(commitMessage) {
 ...
 */
export function parseCommit(commitMessage, hash, author, date) {
    ...
    if (parsed.references) {
        references.push(...parsed.references.map((ref) => `#${ref.issue}`));
    }
    return {
        hash,
 ...
 */
function extractMigrationGuide(description) {
