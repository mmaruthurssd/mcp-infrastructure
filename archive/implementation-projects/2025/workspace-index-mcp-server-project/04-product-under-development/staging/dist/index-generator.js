...
export class IndexGenerator {
    ...
    INDEX_FILE_NAME = 'PROJECT_INDEX.md';
    METADATA_FILE_NAME = '.index-metadata.json';
     ...
     */
    async updateIndexesForPaths(paths) {
        const updated = [];
        const errors = [];
        await this.loadMetadata();
     ...
     */
    async checkIndexFreshness(relativePath) {
        await this.loadMetadata();
        const staleIndexes = [];
     ...
     */
    generateFolderMarkdown(dirPath, files) {
     ...
     */
    async writeIndexFile(dirPath, content) {
